...
export default function Dashboard(){
  ...
  const progress=items.filter(x=>x.status==='in_progress').length;
  ...
  return <>
    <div className="hero-row">
      ...
      <div className="actions">
        ...
        <Link className="button" to="/grievance/new">＋ Report an issue</Link>
      </div>
    </div>
    ...
    <div className="panel table-panel">
      <div className="panel-head">
        <div>
          ...
          <span>
            {items.length} report{items.length!==1?'s':''} submitted
          </span>
        </div>
      ...
      {items.length===0&&!msg?
        <div className="empty">
          ...
          <p>When you report a civic issue, it will appear here.</p>
          <Link className="button" to="/grievance/new">
            ...
            <tbody>
              {items.map(g=>
                <tr key={g.id}>
                  ...
                  <td data-label="Issue" className="title-cell">
                    {g.title}
                  </td>
                  ...
                  <td data-label="Location" className="location-cell">
                    <MapLink
                      lat={g.latitude}
                      lng={g.longitude}
                  ...
                  <td data-label="Routed to" className="location-cell">
                    <MunicipalBadge
